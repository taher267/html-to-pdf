...
const platformsSrc = {
  ...
  const brandLogo="https://app.bizreply.co/platforms/linkedin.png"
  headerObj = {
    title: "title",
...
let file = {
  content: `<html lang='en'><head><meta charset='UTF-8'/><meta name='viewport'content='width=device-width, initial-scale=1.0'/><title>Export to CSV</title></head><body><div style='width: 210mm;height: 297mm;padding: 35px;'><div class='template-top'style='margin-bottom:20px;display: flex;justify-content:space-between;'><div class='template-top-left'><div class='brand-logo'style=''><img src='${brandLogo}'style='height:30px;'alt='brand-logo'/></div><div class='socials'style='display:flex;justify-content:space-between;'>${platforms
    ...
    ", "
  )}</p></div></div></div><div class='template-bottom'style=''><div class='header'><div class='template-bottom'style='margin-bottom:10px;display: flex;justify-content:space-between;'><p>Title</p><p>Short Description</p><p>Date of Reply</p><p>Post Link</p><p>Keyword</p><p>Social</p></div><p>Reply</p></div></div><div class='table-row' style=''>${mentions
    .map(
...
// fs.writeFileSync(path.join(__dirname, "output.txt"), file.content);
// or //
